...
(defun rb-temp-advice (&rest _args)
  (switch-to-buffer-other-window zk-index-buffer-name)
  (setq zk-index-view--kill t)
  (zk-index-next-line))
...
(defun zk-index--propertize-title (title)
...
(defun ezeka-zk--set-scriptum-project (filename &optional new-parent other-window)
